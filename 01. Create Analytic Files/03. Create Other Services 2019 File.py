...
for month_name in month_names:
  ...
  df = spark.table(table_name).select("BENE_ID", "STATE_CD", "CLM_ID", "LINE_NUM", "REV_CNTR_CD", "LINE_PRCDR_CD", "LINE_PRCDR_MDFR_CD_1", "SRVC_PRVDR_NPI", "SRVC_PRVDR_SPCLTY_CD", "LINE_BILLED_AMT", "LINE_MDCD_PD_AMT","LINE_MDCR_PD_AMT","LINE_COPAY_AMT","LINE_MDCD_FFS_EQUIV_AMT")
